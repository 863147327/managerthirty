    ...
    <div>
        ...
        <el-tabs class="tabs" v-model="activeName">
            <el-tab-pane label="动态参数" name="first">
                <el-button class="my-btn" type="primary" size="small" disabled>添加动态参数</el-button>
                <el-table border style="width: 100%">
                    <el-table-column prop="date" label="" width="50">
                    </el-table-column>
                    <el-table-column prop="name" label="#" width="50">
                    </el-table-column>
                    <el-table-column prop="address" label="商品参数" width="200">
                    </el-table-column>
            ...
            <el-tab-pane label="静态参数" name="second">
                <el-button class="my-btn" type="primary" size="small" disabled>添加静态参数</el-button>
                <el-table border style="width: 100%">
                    <el-table-column prop="date" label="" width="50">
                    </el-table-column>
                    <el-table-column prop="name" label="#" width="50">
